...
export const kn = {
  ...
  auth: {
    ...
    phone: 'ಫೋನ್',
    phone_otp_hint: 'ನಿಮ್ಮ 10 ಅಂಕಿಯ ಮೊಬೈಲ್ ನಂಬರ್ ನಮೂದಿಸಿ. OTP SMS ಮೂಲಕ ಕಳುಹಿಸಲಾಗುವುದು.',
    ...
    change_phone: 'ಫೋನ್ ನಂಬರ್ ಬದಲಾಯಿಸಿ',
    otp_sent: 'OTP ಕಳುಹಿಸಲಾಗಿದೆ',
    otp_sent_description: 'ಪರಿಶೀಲನಾ ಕೋಡ್‌ಗಾಗಿ ನಿಮ್ಮ ಫೋನ್ ಪರಿಶೀಲಿಸಿ.',
    otp_invalid: 'ದಯವಿಟ್ಟು ಮಾನ್ಯ 6 ಅಂಕಿಯ OTP ನಮೂದಿಸಿ.',
    check_email_confirm: 'ನಿಮ್ಮ ಖಾತೆಯನ್ನು ದೃಢೀಕರಿಸಲು ನಿಮ್ಮ ಇಮೇಲ್ ಪರಿಶೀಲಿಸಿ. ಪ್ರಾರಂಭಿಸಲು ಇಮೇಲ್‌ನಲ್ಲಿನ ಲಿಂಕ್ ಕ್ಲಿಕ್ ಮಾಡಿ.',
    email_confirmation_required: 'ಇಮೇಲ್ ದೃಢೀಕರಣ ಅಗತ್ಯ',
    select_role_to_login: 'ಸೈನ್ ಇನ್ ಮಾಡಲು ನಿಮ್ಮ ಪಾತ್ರವನ್ನು ಆಯ್ಕೆ ಮಾಡಿ',
    phone_or_email_exists: 'ಈ ಫೋನ್ ನಂಬರ್ ಅಥವಾ ಇಮೇಲ್ ಈಗಾಗಲೇ ನೋಂದಾಯಿಸಲಾಗಿದೆ. ದಯವಿಟ್ಟು ಸೈನ್ ಇನ್ ಮಾಡಿ.',
    signup_failed: 'ಸೈನ್ ಅಪ್ ವಿಫಲವಾಗಿದೆ',
    account_exists: 'ಖಾತೆ ಈಗಾಗಲೇ ಅಸ್ತಿತ್ವದಲ್ಲಿದೆ',
    rate_limit_exceeded: 'ಚಲಾವಣೆ ಮಿತಿ ಮೀರಿದೆ. ದಯವಿಟ್ಟು ಸುಮಾರು ಒಂದು ಗಂಟೆಯ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
    rate_limit_retry_hint: 'ಚಲಾವಣೆ ಮಿತಿ ಮೀರಿದೆ. ದಯವಿಟ್ಟು ಸುಮಾರು ಒಂದು ಗಂಟೆಯ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
    email_optional: 'ಇಮೇಲ್ (ಐಚ್ಛಿಕ)',
    email_optional_hint: 'ಐಚ್ಛಿಕ. ಖಾತೆ ಮರುಪಡೆಯಲು ಬಳಸಲಾಗುತ್ತದೆ.',
  },
  ...
  roles: {
    ...
    farmer_description: 'ನಿಮ್ಮ ಉತ್ಪನ್ನವನ್ನು ನೇರವಾಗಿ ಮಾರಿ',
    buyer: 'ಖರೀದಿದಾರ',
    buyerDesc: 'ಗುಣಮಟ್ಟದ ಉತ್ಪನ್ನಗಳನ್ನು ಪಡೆಯಿರಿ',
    buyer_description: 'ಗುಣಮಟ್ಟದ ಉತ್ಪನ್ನಗಳನ್ನು ಪಡೆಯಿರಿ',
    agent: 'ಏಜೆಂಟ್',
    agentDesc: 'ಕ್ಷೇತ್ರ ಡೇಟಾ ಸಂಗ್ರಹಿಸಿ',
    agent_description: 'ಕ್ಷೇತ್ರ ಡೇಟಾ ಸಂಗ್ರಹಿಸಿ',
    logistics: 'ಸಾರಿಗೆ',
    logisticsDesc: 'ಸರಕು ತಲುಪಿಸಿ',
    logistics_description: 'ಸರಕು ತಲುಪಿಸಿ',
    admin: 'ನಿರ್ವಾಹಕ',
  ...
  farmer: {
   ...
   market: {
     title: 'ಮಂಡಿ ಬೆಲೆಗಳು',
     staleData: 'ಡೇಟಾ ಹಳೆಯದಾಗಿರಬಹುದು. ಇತ್ತೀಚಿನ ಬೆಲೆಗಳಿಗಾಗಿ ರಿಫ್ರೆಶ್ ಟ್ಯಾಪ್ ಮಾಡಿ.',
     setDistrict: 'ವೈಯಕ್ತಿಕ ಬೆಲೆಗಳಿಗಾಗಿ ನಿಮ್ಮ ಜಿಲ್ಲೆಯನ್ನು ಹೊಂದಿಸಿ.',
     addCrops: 'ಹೆಚ್ಚು ಸಂಬಂಧಿತ ಬೆಲೆಗಳನ್ನು ನೋಡಲು ಬೆಳೆಗಳನ್ನು ಸೇರಿಸಿ.',
     noData: 'ಬೆಲೆ ಡೇಟಾ ಲಭ್ಯವಿಲ್ಲ',
     syncPending: 'ಬೆಲೆ ಸಿಂಕ್ ಬಾಕಿಯಿದೆ',
  ...
  validation: {
    ...
    phone_required: 'ದಯವಿಟ್ಟು ಮಾನ್ಯ 10 ಅಂಕಿಯ ಫೋನ್ ನಂಬರ್ ನಮೂದಿಸಿ',
