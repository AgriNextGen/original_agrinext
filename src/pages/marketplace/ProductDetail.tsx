        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Badge className={statusColors[displayStatus] || 'bg-gray-100'}>
              {displayStatus === 'active' ? 'Available' : displayStatus === 'sold_out' ? 'Sold Out' : displayStatus}
            </Badge>
          </div>
        }
      >
            ...
            <div className="space-y-4 py-4">
              <div className="p-3 bg-muted rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Available: {product.available_qty} {product.unit} &middot; ₹{product.unit_price}/{product.unit}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="quantity"
                  type="number"
                  placeholder={`Max: ${product.available_qty} ${product.unit}`}
                  value={orderQuantity}
