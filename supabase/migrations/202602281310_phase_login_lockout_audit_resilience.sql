-- Ensure failed-login lockout enforcement does not break if audit logging schema
-- drifts. Audit logging remains best-effort; profile counters and blocks must apply.
